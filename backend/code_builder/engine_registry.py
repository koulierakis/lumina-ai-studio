...
class CodingEngineRegistry:
    ...
    def public_status(self)->dict[str,object]:return{"default":NATIVE_ENGINE,"engines":[asdict(o)for o in self.options()],"migration_mode":"parallel"}
